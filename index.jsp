                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                            	<!--<li class="page-scroll"> <a href="">狀態查詢</a> </li>  -->
                    ...
                    <li>
                        <div class="dropdown">
                            <button type="button" class="btn btn-lg btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> 技術指導</button>
                            <ul class="dropdown-menu" role="menu">
                                <li class="page-scroll"> <a href="Q&A.jsp">Q&A</a> </li>
                                <li class="page-scroll"> <a href="#instructor">教練諮詢</a> </li>
                            </ul>
                        </div>
                    </li>
            			...
            			<div class="panel panel-default">
            				<div class="panel-heading" role="tab" id="headingFour">
            					...
            					<h4 class="panel-title">
            						...
            						aria-expanded="true" aria-controls="collapseFour">2017 APP 移動應用創新賽決賽結果公布
            						</a>
            					</h4>
            					</li></ul>
            				</div>
            			...
            			<div class="panel panel-default">
            				<div class="panel-heading" role="tab" id="headingThree">
            					...
            					<h4 class="panel-title">
            						...
            						aria-expanded="false" aria-controls="collapseThree">2017 APP 移動應用創新賽7/18(二)議程
            						</a>
            					</h4>
            					</li></ul>
            				</div>
            			...
            			<div class="panel panel-default">
            				<div class="panel-heading" role="tab" id="headingOne">
            					...
            					<h4 class="panel-title">
            						...
            						aria-expanded="false" aria-controls="collapseOne">2017 APP 移動應用創新賽初審結果公布
            						</a>
            					</h4>
            					</li></ul>
            				</div>
            			...
            			<div class="panel panel-default">
            				<div class="panel-heading" role="tab" id="headingTwo">
            					...
            					<h4 class="panel-title">
            						...
            						aria-expanded="false" aria-controls="collapseTwo">2017 APP 移動應用創新賽 - 北區沙龍座談活動
            						</a>
            					</h4>
            					</li></ul>
            				</div>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <table style="width: 100%;"  class="text-center">
                        <tr>
                            <th class="text-center"><p>截止日期</p></th>
               ...
               <div class="col-lg-10 col-lg-offset-2">
                    <table style="width: 80%"  class="text-center">
                        ...
                        <tr>
                            ...
                            <td><p>1隊</p></td>
                            <td class="col-md-8">
                            	<p style="color: #760000">MacBook Pro具備Touch Bar和Touch ID價值NT$57,900乙台</p>
                            	<p style="color: #760000">指導老師獎金NT$30,000</p>
                            </td>
                        </tr>
                        <tr>
                            <td><p>一獎</p></td>
                            <td><p>1隊</p></td>
                            <td class="col-md-8">
                            	<p style="color: #760000">iPhone 7 Plus 256GB 價值NT$36,900乙台</p>
                            	<p style="color: #760000">指導老師獎金NT$20,000</p>
                            </td>
                        </tr>
                        <tr>
                            <td><p>二獎</p></td>
                            <td><p>1隊</p></td>
                            <td class="col-md-8">
                            	<p style="color: #760000">iPad Pro 9.7 吋256GB 價值NT$25,900乙台</p>
                            	<p style="color: #760000">指導老師獎金NT$10,000</p>
                            </td>
                        </tr>
                        <tr>
                            <td><p>三獎</p></td>
                            <td><p>1隊</p></td>
                            <td class="col-md-8">
                            	<p style="color: #760000">iPad Air 2 128GB 價值NT$16,900乙台</p>
                            	<p style="color: #760000">指導老師獎金NT$8,000</p>
                            </td>
                        </tr>
                        <tr>
                            <td><p>優勝獎</p></td>
                            <td><p>1隊</p></td>
                            <td class="col-md-8">
                            	<p style="color: #760000">iPad mini 4 32GB 價值NT$13,900 乙台</p>
                            	<p style="color: #760000">指導老師獎金NT$6,000</p>
                            </td>
                        </tr>
                    </table>
                    <br>
                    <p>※以上得獎者將由主辦單位贊助機票、住宿，參加浙江大學舉辦之大中華區「2017年APP移動應用創新賽」複賽。</p>
                    <p>※決賽證明：經主辦單位審核進入決賽之20名隊伍，隊伍成員每人皆可獲得決賽證明書乙份。</p>
                            ...
                            <tr>
                                <td>
                                    <ol>
                                        ...
                                        <li><p style="color: #760000"><strong>決賽所選出隊伍，將由主辦單位贊助機票、住宿，有義務參加8月浙江大學舉辦之大中華區「2017年APP移動應用創新賽」複賽，每隊限四位名額，包含指導老師一名，三位學生，如無法參加者，將取消名次與獎項，由下⼀名隊伍遞補，出賽時須配合繳交此活動相關資料。</strong></p></li>
                                    </ol>
                                </td>
                            </tr>
                        </table>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <p>※ 各參賽隊伍可以運用以下主題，我們將提供業界講師及設備，免費提供相關APP開發支持。</p>
                    <p>※ 如果您的APP開發內容需要以下主題技術諮詢與設備，請簡短說明您的需求(300字以內)，並留下您的姓名、學校科系、聯絡電話、Email，將儘速請專人回覆予您。</p>
                    <p>※ 技術諮詢客服信箱：stacse@straighta.com.tw</p>
                    <br>
                    <div class="col-lg-8 col-lg-offset-2">
                    <table>
                        <tr>
                            <th class="col-lg-4"><p>技術支援公司</p></th>
                            <th><p>項目</p></th>
                        </tr>
                        <tr>
                            <td>
                                <a href="http://www.myvita.com.tw" style="font-size: 18px">中保無限家</a>
                                <br>
                                <a href="http://www.myvita.com.tw" style="font-size: 18px">台濼科技</a>
                            </td>
                            <td><p>物聯網、居家監控、居家安全</p></td>
                        </tr>
                        <tr>
                            <td><a href="http://www.foracare.com.tw" style="font-size: 18px">泰博科技</a></td>
                            <td><p>社會醫療、遠距照護</p></td>
                        </tr>
                        <tr>
                            <td><a href="http://www.opro9.com/" style="font-size: 18px">瀚荃公司</a></td>
                            <td><p>藍芽溫度、濕度偵測器、iOS 開發與應用</p></td>
                        </tr>
                        <tr>
                            <td><a href="http://www.qblinks.com" style="font-size: 18px">聯合光纖通信</a></td>
                            <td><p>藍芽控制器開發、iOS 開發環境說明</p></td>
                        </tr>
                        <tr>
                            <td><a href="http://www.atomaxinc.com" style="font-size: 18px">匯智創作</a></td>
                            <td><p>X Code設定專案環境、使用重量控制及APP 開發環境</p></td>
                        </tr>
                    </table>
                    <br>
                    <div class="col-lg-4 col-lg-offset-4">
                        <a href="HowToJoiniOSDeveloperProgram.pdf" class="btn btn-default" target = "_blank">如何申請開發者帳號</a>
                    </div>
                    </div>
                </div>
            </div>
